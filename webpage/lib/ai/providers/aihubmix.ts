...
export class AIHubMixProvider extends AIProvider {
  ...
  private static PRICING: Record<string, { input: number; output: number }> = {
    // Claude 系列（官价 ×¥7.2；旧表 opus 误用了 Opus 4.1 的 $15/$75，实为 $5/$25）
    'claude-opus-4-8': { input: 0.036, output: 0.18 },
    'claude-opus-4-6': { input: 0.036, output: 0.18 },
    'claude-sonnet-5': { input: 0.0216, output: 0.108 },
